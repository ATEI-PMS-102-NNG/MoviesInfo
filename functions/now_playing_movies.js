function nowPlayingMovies() {
    ...
    var settings = {
        "async": true,
        "crossDomain": true,
        "url": "https://api.themoviedb.org/3/movie/now_playing?api_key=b5456db86ace1556b60313e04972fc9f&language=en-US&page=1",
        "method": "GET",
        "headers": {},
        "data": "{}"
    };
    ...
    $.ajax(settings).done(function (response) {
        ...
        for (i = 0; i < response.results.length; i++) {
            ...
            document.getElementById("currentResults").appendChild(movieWrapper2);
